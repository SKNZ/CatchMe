...
namespace Game
{
     ...
     * 
     */
    const std::chrono::milliseconds     KErrorMessageDisplayTime(2000); // The duration during which the game will be suspended to let the player read the error message.
