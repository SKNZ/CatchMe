...
namespace
{
    ...
    {
        Menu::Clear();
        Menu::AddItem("1 player", [&PlayerCount]() { PlayerCount = 1; });
        Menu::AddItem("2 players", [&PlayerCount]() { PlayerCount = 2; });
        Menu::AddItem("3 players", [&PlayerCount]() { PlayerCount = 3; });
        Menu::AddItem("4 players", [&PlayerCount]() { PlayerCount = 4; });
        Menu::Run();
    }
